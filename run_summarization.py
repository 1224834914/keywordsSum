...
# Where to find data
tf.app.flags.DEFINE_string('data_path', 'data/finished_files/chunked/train_*.bin', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
...
tf.app.flags.DEFINE_string('log_root', 'data/finished_files/log', 'Root directory for all logging.')
tf.app.flags.DEFINE_string('exp_name', 'myexp', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')

tf.app.flags.DEFINE_integer('keyword_num',8 , 'the unm of the keywords')

# Hyperparameters
tf.app.flags.DEFINE_integer('hidden_dim', 256, 'dimension of RNN hidden states')
tf.app.flags.DEFINE_integer('emb_dim', 128, 'dimension of word embeddings')
tf.app.flags.DEFINE_integer('batch_size', 16, 'minibatch size')
tf.app.flags.DEFINE_integer('max_enc_steps', 1000, 'max timesteps of encoder (max source text tokens)')
...
def main(unused_argv):
  ...
  hparam_list = ['mode', 'lr', 'adagrad_init_acc', 'rand_unif_init_mag', 'trunc_norm_init_std', 'max_grad_norm', 'hidden_dim', 'emb_dim', 'batch_size', 'max_dec_steps', 'max_enc_steps', 'coverage', 'cov_loss_wt', 'pointer_gen','keyword_num']
  hps_dict = {}
